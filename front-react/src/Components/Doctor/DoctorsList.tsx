...
const DoctorsList = () => {
    ...
    return (
        <div className='container'>
            ...
            <h3 className='txt'>
                <img src='/images/doctor.png' style={{ width: '60px', height: '60px', borderRadius: '50%', margin: '15px' }}></img>Doctors</h3>
            ...
            <div className="input-group flex-nowrap my-2">
                ...
                <button className="btn bg-white ms-n3" style={{ margin: '1px' }} type="button" onClick={e => {
                    ...
                    <img src='/images/search.png' style={{ width: '30px', height: '30px', borderRadius: '50%' }}></img>
                </button>
            ...
            <div className='row justify-content-center'>
                <div className='col-8 col-md-2'>
                    <Link className='btn btn-outline-dark w-100 my-3' to={'/doctor/add'} state={{ from: loc }}>
                        <img src='/images/add.png' style={{ width: '30px', height: '30px', borderRadius: '50%', marginRight: '10px' }}></img> Add Doctor
