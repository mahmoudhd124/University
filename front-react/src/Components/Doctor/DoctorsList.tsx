        ...
        <div className='container'>
            ...
            <h3 className='txt'>
                <img src='/images/doctor.png'
                     style={{width: '60px', height: '60px', borderRadius: '50%', margin: '15px'}}></img>Doctors</h3>
            ...
            <div className="overflow-scroll">
                <table className="table table-striped table-hover text-center">
                    ...
                    {data?.map((d, i) => <tr key={d.id}>
                        ...
                        <td><Link to={'/doctor/' + d.id} state={{from: loc}}
                                  style={{textDecoration: 'none'}}>{d.username}</Link></td>
