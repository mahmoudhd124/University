...
const DoctorPage = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="doctor bg-white shadow rounded-lg d-block d-sm-flex ">
                <div className="profile-tab-nav border-right">
                    <div className="p-4">
                        <div className="img-circle text-center mb-3 ">
                            <img src="../../../public/Images/doctor.png" alt="Image" className="shadow"></img>
                        </div>
                        <h3 className="row justify-content-center my-1 mt-5">
                            <DoctorField title={''} data={data?.firstname! + " " + data?.lastname!} />
                ...
                <div className="info ">
                    <p className="col-lg-10 "><DoctorField title={'First Name:'} data={data?.firstname!} /></p>
                    <p className="col-lg-10"><DoctorField title={'Last Name:'} data={data?.lastname!} /></p>
                    <p className="col-lg-10"><DoctorField title={'User Name:'} data={data?.username!} /></p>
                    <p className="col-lg-10"><DoctorField title={'Email:'} data={data?.email!} /></p>
                    <p className="col-lg-10"><DoctorField title={'Phone Number:'} data={data?.phoneNumber!} /></p>
                    <p className="col-lg-10"><DoctorField title={'National Number:'} data={data?.nationalNumber!} /></p>
