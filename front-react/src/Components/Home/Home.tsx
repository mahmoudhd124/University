    ...
    return (
        <section className={'main'}>
            <div className="container">
                <img src="../../../public/Images/universty.jpg" className={'bg-img'} alt=""/>
                ...
                <h5>Welcome to our site for managing doctors at the university. Our platform allows the director to
